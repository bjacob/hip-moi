...
3.43 µs pass-through and 13.4 µs through `context` on the local RDNA4 machine,
...
Status: in progress. The first fast-path change targets the atomic-object table
